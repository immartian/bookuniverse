...
export class ISBNCountyHandler {
    ...
    getZoneRange(prefix) {
        const startISBN = this.padToISBN(prefix, "0");
        const endISBN = this.padToISBN(prefix, "9");
        ...
        let startRow, endRow;  /// special case for 978-0 and 978-1 
        if (prefix === "9780" || prefix === "9781") {
            startRow = Math.floor((this.padToISBN("978-0", "0") - this.baseISBN) / this.isbnPerPixel / this.imageWidth);
            endRow = Math.floor((this.padToISBN("978-1", "9") - this.baseISBN) / this.isbnPerPixel / this.imageWidth);
        }
        else
        {
            startRow = Math.floor((startISBN - this.baseISBN) / this.isbnPerPixel / this.imageWidth);
            endRow = Math.floor((endISBN - this.baseISBN) / this.isbnPerPixel / this.imageWidth);
        }
