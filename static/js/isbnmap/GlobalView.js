...
export class GlobalView extends View {
    ...
    drawBase(scale=1) {
        ...
        if (this.image.src !== `/static/images/isbnmap/1_50/all_isbns_${this.highlighted}_1_50.png`) {
            this.image.src = `/static/images/isbnmap/1_50/all_isbns_${this.highlighted}_1_50.png`;
        }    
    }
    ...
    handleHover(data) {
        ...
        this.image.src = `/static/images/isbnmap/1_50/all_isbns_${this.highlighted || 'md5'}_1_50.png`;
